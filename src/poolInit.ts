import fs from "fs";
import { PublicKey, Keypair, Transaction, SystemProgram, Connection, sendAndConfirmTransaction, type Commitment, SYSVAR_RENT_PUBKEY } from "@solana/web3.js";
import { Program } from "@project-serum/anchor";
import { createAssociatedTokenAccountInstruction, createInitializeMintInstruction, getAccount, getAssociatedTokenAddressSync } from "@solana/spl-token";
...
async function initPoolST() {
    try {
        ...
        const tokenSInfo = {
            "mint": "3eb5bXPzknE9CpbWjz8ALBqf1dZ5tEGcVwcocb41UU1z",
            "userATA": "9bWZbvpmBrvgBvKAMJysG9rG8ZpBYjvumBj7SLsnzCFC",
            "supply": 1000000000000,
            "decimals": 9,
            "transactionSignature": "5qQJoVRPBwKKmeuVQfRM9vmLL5UEpRrdcHyFmbyDS3zWHsE753Ydc9yaUkt6EZSaeP5vWki8VSv6tDUcrRSrfkbe"
          }
        const tokenTInfo = {
            "mint": "CoSyfv9FSYgGPzPhq1J46g4jMeEbuuQgsfdN4E4WtciP",
            "userATA": "9bWZbvpmBrvgBvKAMJysG9rG8ZpBYjvumBj7SLsnzCFC",
            "supply": 1000000000000,
            "decimals": 9,
            "transactionSignature": "5qQJoVRPBwKKmeuVQfRM9vmLL5UEpRrdcHyFmbyDS3zWHsE753Ydc9yaUkt6EZSaeP5vWki8VSv6tDUcrRSrfkbe"
